...
const HomeCoverSection = ({ blogs }) => {
    ...
    return (
        <div className='w-full inline-block'>
            ...
            ' />
                <Image src={blog.image.filePath.replace("../public", "")} placeholder='blur' blurDataURL={blog.image.blurhashDataUrl} alt={blog.title} fill className='h-full w-full object-center object-cover rounded-3xl -z-10' sizes='100vw' priority />
